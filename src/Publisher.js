...
export class Publisher extends Component{
    ...
    refreshList(){
        fetch(variables.API_URL + "publishers")
    ...
    editClick(publ){
        this.setState({
            ...
            PublisherName: publ.PublisherName
        })
    }
    ...
    deleteClick(id){
        ...
        {
        fetch(variables.API_URL + "publishers/" + id, {
            method: 'DELETE',
            headers: {
                'Accept': 'application.json',
                'Content-Type': 'application/json'
                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <div className="input-group mb-3">
                                        <span className="input-group-text">PublisherName</span>
